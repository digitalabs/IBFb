...
public final class NewTrialAction extends SystemAction {//implements ActionListener {
    ...
    private ImageIcon icono = ImageUtilities.loadImageIcon("ibfb/studyexplorer/images/newTrial16.png", false);
...
//    }
    ...
    public void actionPerformed(ActionEvent ev) {
        if (studyOBJ.getStudyid() == null) {
            DialogUtil.displayError(bundle.getString("NewTrialAction.selectAStudy"));
            return;
        }
