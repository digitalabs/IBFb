...
public interface WorkbookExcelReader {
    ...
    public static final String GERMPLASM_TEMPLATE_LIST_NAME = "LIST NAME";
    public static final String GERMPLASM_TEMPLATE_TITLE = "TITLE";
    public static final String GERMPLASM_TEMPLATE_LIST_TYPE = "LIST TYPE";
    public static final String GERMPLASM_TEMPLATE_LIST_DATE = "LIST DATE";
